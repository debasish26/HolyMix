...
const Navbar = () => {
  ...
  useEffect(() => {
    // Check for a JWT token in localStorage to verify login status
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <h1 className="text-red-500 text-xl md:text-2xl font-bold">Holymix</h1>
            <div className="hidden md:flex ml-10 items-baseline space-x-4">
              <a href="/" className="text-white px-3 py-2 rounded-md text-sm font-medium">Home</a>
              <a href="/genres" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Browse</a>
              ...
              {isLoggedIn ? (
                ...
                <a href="/accounts" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Login</a>
              )}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-gray-800 shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="/genres" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Browse</a>
