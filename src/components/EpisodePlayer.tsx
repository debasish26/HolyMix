            ...
            <div className="max-w-7xl mx-auto py-8">
                <div className="relative">
                    ...
                    <div className="bg-gray-800 rounded-lg p-4 mb-6 mt-6">
                        ...
                        <div className="mb-4">
                            <label
                                htmlFor="episode-range"
                                className="text-white block mb-2 text-sm sm:text-base md:text-lg"
                            >
                            ...
                            >
                                {/* Generate options dynamically based on the selected version */}
                                {Array.from(
                                    { length: Math.ceil((selectedVersion === 'sub' ? availableEpisodes.sub : availableEpisodes.dub) / 10) },
                                    (_, i) => {
                                        const start = i * 10 + 1;
                                        const end = Math.min((i + 1) * 10, selectedVersion === 'sub' ? availableEpisodes.sub : availableEpisodes.dub);
                                        return (
